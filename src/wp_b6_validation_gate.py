...
RASTER_DIR = r"F:\CBH"
CR_TIF  = os.path.join(RASTER_DIR, "CR_HM변형-try2.0-plotdisjoint_SEED100.tif")
CBH_TIF = os.path.join(RASTER_DIR, "CBH_meter_HM변형-try2.0-plotdisjoint_SEED100.tif")
TAG_DIR = os.path.join(r"D:\ForestFire\CBH\result\Baseline3", "HM변형-try2.0-plotdisjoint")
BUNDLE  = os.path.join(TAG_DIR, "model", "hybrid_plotdisjoint_SEED100.joblib")
CAT_CSV = os.path.join(TAG_DIR, "Pred-NIFS-ComparebyCategory_plotdisjoint_SEED100.csv")
REPORT  = os.path.join(TAG_DIR, "WP-B-6_validation_report.txt")
