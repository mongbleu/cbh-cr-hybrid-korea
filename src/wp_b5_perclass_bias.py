...
P = r"result/Baseline3/HM변형-try2.0-plotdisjoint/Pred-NIFS-ComparebyCategory_plotdisjoint_SEED100.csv"
OUT = r"result/Baseline3/HM변형-try2.0-plotdisjoint/perclass_bias_plotdisjoint_SEED100.csv"
