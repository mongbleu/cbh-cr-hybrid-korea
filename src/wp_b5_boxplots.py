...
Standalone replica of the two box-plot cells in src/논문-Visualize.ipynb (the `compare1_file` data-prep
...
RESULT_DIR = os.path.join(r"D:\ForestFire\CBH\result\Baseline3", "HM변형-try2.0-plotdisjoint")
COMPARE_CSV = os.path.join(RESULT_DIR, "Pred-NIFS-ComparebyCategory_plotdisjoint_SEED100.csv")
