...
box-plots in `논문-Visualize.ipynb` reflect the plot-disjoint model instead of the INVALID CBH4.tif.

What changes vs. the notebook (see memory/sessions/2026-06-23_session-handoff.md):
  - pred raster: F:\\CBH\\CBH4.tif (INVALID)  →  F:\\CBH\\CBH_meter_HM변형-try2.0-plotdisjoint_SEED100.tif
  - output:      Pred-NIFS-ComparebyCategory_CR4.csv  →  Pred-NIFS-ComparebyCategory_plotdisjoint_SEED100.csv
...
# ----------------------------------------------------------------------------- config / provenance
RASTER_DIR = r"F:\CBH"
PRED_MAP   = os.path.join(RASTER_DIR, "CBH_meter_HM변형-try2.0-plotdisjoint_SEED100.tif")  # NEW corrected map
...
OUT_DIR     = os.path.join(r"D:\ForestFire\CBH\result\Baseline3", "HM변형-try2.0-plotdisjoint")
OUT_TAG     = "plotdisjoint_SEED100"
OUT_NAME    = f"Pred-NIFS-ComparebyCategory_{OUT_TAG}.csv"
